      ...
      <section id="services" className="services">
        <div className="container">
          <div className="section-title">
            <h2 className="d-flex flex-column align-items-center pt-5 "><div className="velit-item">SERVICES</div></h2>
          ...
          <div className="row pt-4">
            <div className="col-lg-4 col-md-6">
              <div className="card">
                ...
                <div className="services-card mt-4"> 
                  ...
                  <p className="icon-main">
                    <i className="fa-brands fa-dribbble" />
                  </p>
                </div> 
                <h4 className="card-title">Lorem Ipsum</h4>
                <p className="card-text">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi</p>                     
                {/* </div> */}
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="card ">
                {/* <div class="card-body"> */}
                <div className="services-card1 mt-4">
                  <svg width={100} height={100} viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-lg-4 col-md-6 ">
              <div className="card">
                {/* <div class="card-body"> */}
                <div className="services-card2 mt-4">
                  <svg width={100} height={100} viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="icon-main2">
                    <i className="fa-solid fa-file-lines" />
                  </p>
                </div>
                <h4 className="card-title">Sed Perspiciatis</h4>
            ...
            <div className="col-lg-4 col-md-6 mt-4">
              <div className="card">
                {/* <div class="card-body"> */}
                <div className="services-card3 mt-4">
                  <svg width={100} height={100} viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="icon-main3">
                    <i className="fa-brands fa-slideshare" />
                  </p>
                </div>
                <h4 className="card-title ">Dele Cardo</h4>
                <p className="card-text">Quis consequatur saepe eligendi voluptatem consequatur dolor consequuntur</p>
                {/* </div> */}
              </div>
            </div>
            <div className="col-lg-4 col-md-6 mt-4">
              <div className="card">
                {/* <div class="card-body"> */}
                <div className="services-card4 mt-4">
                  <svg width={100} height={100} viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-lg-4 col-md-6 mt-4">
              <div className="card">
                {/* <div class="card-body"> */}
                <div className="services-card5 mt-4">
                  <svg width={100} height={100} viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="icon-main5">
                    <i className="fa-solid fa-archway" />
                  </p>
                </div>
                <h4 className="card-title">Divera Don</h4>
                <p className="card-text"> Modi nostrum vel laborum. Porro fugit error sit minus sapiente sit aspernatur</p>
                {/* </div> */}
              </div>
            </div>
          </div>
